package com.example.almacenamientodatossd;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_nombre = (EditText)findViewById(R.id.editTextTextPersonName);
        et_contenido = (EditText)findViewById(R.id.editTextTextMultiLine);
    }
